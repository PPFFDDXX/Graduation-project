    ...
    case HTP_OPS_RELU_F32:
      {
        ...
        validate_in_bufs();
        ret = hvx_relu_f32((float *) OUT_PTR(0), (const float *) IN_PTR(0), params->ne0, params->ne1);
        validate_out_bufs();
      }
      break;
    ...
    case HTP_OPS_LEAKY_RELU_F32:
      {
        ...
        validate_in_bufs();
        ret = hvx_leaky_relu_f32((float *) OUT_PTR(0), (const float *) IN_PTR(0), params->ne0, params->ne1);
        validate_out_bufs();
      }
      break;
    ...
    case HTP_OPS_SIGMOID_F32:
      {
        ...
        validate_in_bufs();
        ret = hvx_sigmoid_f32((float *) OUT_PTR(0), (const float *) IN_PTR(0), params->ne0, params->ne1);
        validate_out_bufs();
      }
      break;
    ...
    case HTP_OPS_SILU_F32:
      {
        ...
        validate_in_bufs();
        ret = hvx_silu_f32((float *) OUT_PTR(0), (const float *) IN_PTR(0), params->ne0, params->ne1);
        validate_out_bufs();
      }
      break;
    ...
    case HTP_OPS_SOFTMAX_F32:
      {
        ...
        validate_in_bufs();
        ret = hvx_softmax_f32((float *) OUT_PTR(0), (const float *) IN_PTR(0), params->ne0, params->ne1);
        validate_out_bufs();
      }
      break;
